...
var virtualRow = function (name) {
    console.log('Name in virutalRow is: ', name);
    ...
    console.log('--> Typeof var ident in virtualRow is: ', typeof ident);
    console.log('--> String value of ident is: ', Object.prototype.toString(ident));
    // console.log('----> The prototype of ident in virtualRow is: ', Object.getPrototypeOf(ident));
    ...
    console.log('--> Typeof var prox in virtualRow is: ', typeof prox);
    console.log('--> String value of prox is: ', Object.prototype.toString(prox));
    // console.log('----> The prototype of ident in virtualRow is: ', Object.getPrototypeOf(prox));
    ...
    console.log('--> Typeof var ret in virtualRow is: ', typeof ret);
    console.log('--> String value of ret is: ', Object.prototype.toString(ret));
    Object.setPrototypeOf(ret, ident);
    // console.log('---> The prototype of red in virtualRow is: ', Object.getPrototypeOf(ret));
    return ret;
};
...
console.log("Type of exports.sql is: ", typeof exports.sql);
console.log("The prototype of exports.sql is: ", Object.getPrototypeOf(exports.sql));
